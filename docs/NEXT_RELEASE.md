...
- Separate the remaining asset-planning and evaluation contracts
...
- Measure and publish install and browser-bundle impact after the optional-peer split shipped in beta.3.
