...
export const LEANLET_MODELS = {
    ...
    'mobileclip-s0-fp16': {
        ...
        limitation: 'Browser support and accuracy should be checked on target devices.',
        sourceRevision: '757d59c9c6870a76a4b0306f05f5061bca15c39f',
        textDtype: 'q8',
        visionDtype: 'fp16',
    },
    ...
    'mobilenet-v4-medium': {
        ...
        sizeMB: 10,
        tier: 'Balanced',
        strength: 'A larger fixed-vocabulary option when Small misses known objects.',
        limitation: 'Fixed ImageNet vocabulary; it cannot follow custom category text.',
